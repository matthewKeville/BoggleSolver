...
/*
 * a classic boggle board is a square board of letters 
 * this will be represented as a list of characters
 * Classic Boggle has a explicit set of dice used for boards 4 - 6 x 4 -6  
 * The original dice will be used for these dimensions and random letters  
 * will be used for boards greater than 6 
 *  
 */
public class Board {
